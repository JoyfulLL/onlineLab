<!--
    @description: Header svg list
    @fileName CustomHeaderSvg.vue
    @author LJF
    @date 2024/04/09
-->

<template>
  <svg :class="iconClass" :viewBox="viewBox">
    <!-- 指右 折叠状态 点击展开-->
    <g v-if="iconName === 'Expand'">
      <path
        d="M895.936 256L896 192 128 191.104v64L895.936 256z m0 288v-64H480v64H896z m0 288L896 768l-768-0.896v64L895.936 832zM179.2 333.952l202.688 152a32 32 0 0 1 0 51.2L179.2 689.152a32 32 0 0 1-51.2-25.6v-304a32 32 0 0 1 51.2-25.6z m12.8 89.6v176l117.312-88L192 423.552z"
        :fill="fillColor"
        fill-opacity=".9"
        p-id="5310"
      ></path>
    </g>
    <g v-else-if="iconName === 'Fold'">
      <!-- 指左 展开状态 点击折叠-->
      <path
        d="M128.064 768L128 832l768 0.896v-64L128.128 768z m0-288v64H544v-64H128zM128 192L128 256l768 0.896v-64L128.128 192zM896 360.448v304a32 32 0 0 1-51.2 25.6l-202.688-152a32 32 0 0 1 0-51.2L844.8 334.848a32 32 0 0 1 51.2 25.6z m-64 64l-117.312 88L832 600.448v-176z"
        :fill="fillColor"
        fill-opacity=".9"
        p-id="5894"
      ></path>
    </g>
    <g v-else-if="iconName === 'usercenter'">
      <!-- 指左 展开状态 点击折叠-->
      <path
